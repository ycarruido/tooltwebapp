...
const Hero = () => (
  ...
  >
    <div className="flex w-full px-4 md:px-20 mx-auto h-full bg-gray-700 bg-opacity-0">
      {" "}
        ...
        <div className="relative bg-cover bg-center">
          ...
          <div className="relative z-10 text-white p-4">
            ...
            <p className="max-w-xl">
              Estamos aquí para ayudarte a alcanzar tus metas universitarias y
              asegurarte el éxito en tu proyecto de investigación: Asesoría •
              Redacción • Metodología • Investigación
            </p>
          </div>
        </div>
